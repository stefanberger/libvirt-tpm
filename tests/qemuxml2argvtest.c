...
# define NONE QEMU_CAPS_LAST
    ...
    DO_TEST("tpm-cuse-tpm-enc", QEMU_CAPS_DEVICE,
            QEMU_CAPS_DEVICE_TPM_PASSTHROUGH, QEMU_CAPS_DEVICE_TPM_CUSE_TPM,
            QEMU_CAPS_DEVICE_TPM_TIS);
    DO_TEST("tpm-cuse-tpm-enc-secret", QEMU_CAPS_DEVICE,
            QEMU_CAPS_DEVICE_TPM_PASSTHROUGH, QEMU_CAPS_DEVICE_TPM_CUSE_TPM,
            QEMU_CAPS_DEVICE_TPM_TIS);
    DO_TEST("tpm-cuse-tpm-spapr-vtpm", QEMU_CAPS_DEVICE,
            QEMU_CAPS_DEVICE_TPM_PASSTHROUGH, QEMU_CAPS_DEVICE_TPM_CUSE_TPM,
            QEMU_CAPS_DEVICE_TPM_SPAPR_VTPM);
    DO_TEST("tpm-cuse-tpm2", QEMU_CAPS_DEVICE,
            QEMU_CAPS_DEVICE_TPM_PASSTHROUGH, QEMU_CAPS_DEVICE_TPM_CUSE_TPM,
            QEMU_CAPS_DEVICE_TPM_TIS);
